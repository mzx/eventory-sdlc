...
describe('UsersService', () => {
  ...
  describe('updateStatus', () => {
    ...
    // EVT-42: `updateStatus` no longer has any workspace side-effect — see
    // its doc comment. Approving/rejecting/re-pending a user only ever
    // touches the `User` row now.
    it('EVT-42: has no workspace side-effect when approving a user', async () => {
